        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div class="card p-6">
                    ...
                    <h3 class="text-lg font-semibold text-on-surface mb-2 text-center">Hard Filter First</h3>
                    <p class="text-on-surface-variant text-sm text-justify">Strict eligibility rules (nationality, income, study level, deadline) filter out unsuitable scholarships before scoring.</p>
                </div>
                ...
                <div class="card p-6">
                    ...
                    <h3 class="text-lg font-semibold text-on-surface mb-2 text-center">Soft Scoring & Ranking</h3>
                    <p class="text-on-surface-variant text-sm text-justify">Academic (40), Field (25), Institution (20), Income (15) = 100 total. Transparent weighted scoring.</p>
                </div>
                ...
                <div class="card p-6">
                    ...
                    <h3 class="text-lg font-semibold text-on-surface mb-2 text-center">Explainable Results</h3>
                    <p class="text-on-surface-variant text-sm text-justify">Every recommendation shows exactly why you qualify or don't — no black box algorithms.</p>
                </div>
                ...
                <div class="card p-6">
                    ...
                    <h3 class="text-lg font-semibold text-on-surface mb-2 text-center">Admin Configurable</h3>
                    <p class="text-on-surface-variant text-sm text-justify">Scholarship rules, income thresholds, and seed data managed via admin panel — no code changes needed.</p>
                </div>
            </div>
        </div>
    </section>
